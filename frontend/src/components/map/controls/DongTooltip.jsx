// 개발 프론트 위치: TERRY\p02_frontEnd_React\src\controls\DongTooltip.jsx
// 공식 프론트 위치: frontend\src\components\map\controls\DongTooltip.jsx
      ...
      >
         ...
         {mode === "sales" &&
            (tooltip.loading ? (
               ...
               <>
                  <div
                     style={{ fontSize: 11, color: "#059669", fontWeight: 700 }}
                  >
                     💰{" "}
                     {tooltip.sales.sales
