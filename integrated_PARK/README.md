...
<<<<<<< HEAD
| `domain` | ⬜ | `"admin"` / `"finance"` / `"legal"`. `null`이면 자동 분류 |
...
<<<<<<< HEAD
│   ├── signoff_finance/evaluate/skprompt.txt   # warnings + grade 기준 포함
│   ├── signoff_legal/evaluate/skprompt.txt     # warnings + grade 기준 포함
│   └── signoff_admin/evaluate/skprompt.txt     # warnings + grade 기준 포함
=======
